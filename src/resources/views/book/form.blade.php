...
<form method="post" action="{{ $book->exists ? '/books/patch/' . $book->id : '/books/put' }}" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" id="book-name" name="name" value="{{ old('name', $book->name) }}" class="form-control @error('name') is-invalid @enderror">
        @error('name')
    ...
    <div class="mb-3">
        <label for="book-category" class="form-label">Kategorija</label>
    ...
    <div class="mb-3">
        ...
        <input type="number" max="{{ date('Y') + 1 }}" step="1" id="book-year" name="year" value="{{ old('year', $book->year) }}" class="form-control @error('year') is-invalid @enderror">
        @error('year')
    ...
    <div class="mb-3">
        ...
        <input type="number" min="0.00" step="0.01" lang="en" id="book-price" name="price" value="{{ old('price', $book->price) }}" class="form-control @error('price') is-invalid @enderror">
        @error('price')
    ...
    <div class="mb-3">
        ...
        @endif
        <input type="file" accept="image/png, image/jpeg" id="book-image" name="image" class="form-control @error('image') is-invalid @enderror">
        @error('image')
